public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(getMinSalary(employees, 2));
        System.out.println(getMaxSalary(employees, 2));
        System.out.println(getAverageOfSalary(employees, 2));
        raiseSalary(employees, 20, 2);
        printAll(employees, 3);
    ...
    public static double getAverageOfSalary(Employee[] arr){
        return getSumOfSalary(arr)/arr.length;
    }
    ...
    public static int getNumberOfEmployee(Employee[] arr, int department){
    ...
    public static Employee[] getNewEmployees(Employee[] arr, int department){
        int length = getNumberOfEmployee(arr, department);
        int count = 0;
